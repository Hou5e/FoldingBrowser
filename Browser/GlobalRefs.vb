Public Module GlobalRefs
    ...
    Public Const URL_FLDC_DefaultBlockchain As String = "https://counterpartychain.io/asset/FLDC"
    Public Const URL_FLDC_AddressBlockchain As String = "https://counterpartychain.io/address/"
