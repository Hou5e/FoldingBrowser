...
Public Class IniFile
    ...
    Public Sub Load(ByVal sFileName As String, Optional ByVal bMerge As Boolean = False)
        ...
        Dim oReader As StreamReader = New StreamReader(sFileName, System.Text.Encoding.Unicode)
    ...
    Public Sub LoadText(ByRef sText As String)
        Dim tempsection As IniSection = Nothing
        Dim oReader As StringReader = New StringReader(sText)
    ...
    Public Sub Save(ByVal sFileName As String)
        Dim oWriter As New StreamWriter(sFileName, False, System.Text.Encoding.Unicode)
